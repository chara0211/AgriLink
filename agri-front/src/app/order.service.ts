...
export class OrderService {
 ...
 private apiUrlValide = 'http://localhost:8000/api'
  ...
  const logoBase64 = 'assets/logo2.png'; // Remplacez par votre Base64
  ...
  const marginRight = 5; // Marge droite
  const marginTop = 5; // Marge en haut
  ...
  doc.setFontSize(14);
  doc.setTextColor(0, 64, 0);
    doc.text('Products details', 10, startY);
  ...
  doc.text('Quantity', 80, startY, { align: 'right' });
  doc.text('Unit Price', 120, startY, { align: 'right' });
